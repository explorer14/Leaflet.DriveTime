...
function GetDriveTimePolygon(origin, driveTimeInMinutes, callback) {
    ...
    for (var i = -180; i < 180; i+=segmentSize) {
        ...
        // add 2 more intermediate visit points to force the API down different routes than just a straight one to increase the granularity
...
function GenerateDriveTimePolygon(driveTimePoints, callback) {
    if (requestsPending == 0) {
        ...
        callback(driveTimePolygonGeoJSON);        
    }    
}